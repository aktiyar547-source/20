...
import com.middleeastcontainer.ui.theme.AlertRed
...
fun MenuScreen(
    ...
    Column(
        ...
        // Read on every return to the menu: space changes as photos upload and
        // the housekeeping job purges.
        ...
        AnimatedVisibility(
            ...
            exit = shrinkVertically(tween(Motion.QUICK, easing = Motion.Exit)) +
            ...
            Card(
                ...
                Column(Modifier.padding(14.dp)) {
                    Text(
                        "Storage almost full — ${storage.freeMb} MB left",
                        fontWeight = FontWeight.Medium,
                        color = AlertRed,
                    )
                    Text(
                        "Roughly ${storage.freeMb / 4} more photos. Upload and let the " +
                            "daily cleanup run, or free space before going out.",
