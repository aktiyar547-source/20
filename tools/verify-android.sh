...
echo "=========================================================="
for check in kt-sanity prose-scan check1_symbols check2_wiring check3_contracts check4_migrations check5_calls check6_properties check7_returns check8_queries; do
